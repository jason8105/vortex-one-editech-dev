...
public class BActivityThread extends IBActivityThread.Stub {
    ...
    public synchronized void handleBindApplication(String packageName, String processName) {
        ...
        if (packageInfo == null || packageInfo.applicationInfo == null) {
            Slog.w(TAG, "packageInfo is null for " + packageName + ", creating fallback package container");
            packageInfo = new PackageInfo();
            packageInfo.packageName = packageName;
            packageInfo.applicationInfo = new ApplicationInfo();
            packageInfo.applicationInfo.packageName = packageName;
            packageInfo.applicationInfo.processName = processName;
            packageInfo.applicationInfo.sourceDir = BlackBoxCore.getContext().getApplicationInfo().sourceDir;
            packageInfo.applicationInfo.dataDir = BlackBoxCore.getContext().getApplicationInfo().dataDir;
